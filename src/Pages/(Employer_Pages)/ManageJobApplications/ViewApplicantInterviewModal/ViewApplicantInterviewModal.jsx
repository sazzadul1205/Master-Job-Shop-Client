...
const ViewApplicantInterviewModal = ({
  refetch,
  ...
  const {
    ...
    queryKey: ["SelectedJobApplicationsData", selectedApplicationID],
    queryFn: () =>
      axiosPublic
