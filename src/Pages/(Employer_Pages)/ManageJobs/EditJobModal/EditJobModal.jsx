...
EditJobModal.propTypes = {
  selectedJobData: PropTypes.shape({
    ...
    niceToHave: PropTypes.arrayOf(PropTypes.string),
    location: PropTypes.string,
    remote: PropTypes.bool,
    hybrid: PropTypes.bool,
    onsite: PropTypes.bool,
    timezoneOverlap: PropTypes.string,
