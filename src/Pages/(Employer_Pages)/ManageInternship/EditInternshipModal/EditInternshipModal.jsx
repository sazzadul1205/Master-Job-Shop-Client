...
const EditInternshipModal = ({ refetch, selectedInternshipData }) => {
  ...
  }, [selectedInternshipData, reset]);

  // On Submit Handler
  const onSubmit = async (data) => {
    if (!selectedInternshipData?._id) return; // No Internhip selected, exit
    ...
    try {
      const response = await axiosPublic.put(
        `/Internship/${selectedInternshipData._id}`,
        data
      );
...
// Prop Validation
EditInternshipModal.propTypes = {
  refetch: PropTypes.func,
  selectedInternshipData: PropTypes.shape({
