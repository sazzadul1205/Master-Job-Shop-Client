...
const MentorDeleteMentorshipModal = () => {
  ...
  // Assuming MyMentorshipApplicationsData contains the API response
  const allApplicantIds = MyMentorshipApplicationsData
    ? Object.values(MyMentorshipApplicationsData) // get all arrays
        .flat() // flatten arrays into a single array
        .map((applicant) => applicant._id) // extract _id
    : [];
