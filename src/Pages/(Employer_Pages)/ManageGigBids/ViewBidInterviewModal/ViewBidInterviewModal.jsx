...
const ViewBidInterviewModal = ({
  ...
  const {
    ...
    queryKey: ["SelectedGigBidData", selectedBidID],
    queryFn: () =>
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await axiosPublic.put(`/GigBids/Accepted/${selectedBidID}`, payload);
    ...
    <div className="modal-box bg-white rounded-xl shadow-md p-0 max-w-3xl">
      ...
      <div className="flex justify-between items-center border-b px-5 py-4">
        ...
        <button
          ...
          onClick={() => {
            document.getElementById("View_Bid_Interview_Modal").close();
...
// Prop Validation
ViewBidInterviewModal.propTypes = {
  refetch: PropTypes.func.isRequired,
  selectedBidID: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
  setSelectedBidID: PropTypes.func.isRequired,
};

export default ViewBidInterviewModal;
