...
// Components
import CompanyProfileLogoUpload from "../AddCompanyProfileModal/CompanyProfileLogoUpload/CompanyProfileLogoUpload";
...
const EditCompanyProfileModal = ({ company, refetch }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      let uploadedImageUrl = company.logo; // Default to existing logo

      // Upload new logo only if changed
      if (profileImage && profileImage !== company.logo) {
      ...
      refetch();
      setErrorMessage("");
      document.getElementById("Edit_Company_Profile_Modal").close();
    } catch (error) {
